...
def filter_products(cattegory: str,
                    product: models.MainProductDatabase) -> Dict:
    ...
    if cattegory == 'Phones':
        ...
        same_products_data = {
            'items': same_products,
            'colors': check_no_data({element.phones_product_data.color
                                     for element in same_products}),
            'memory': check_no_data({element.phones_product_data.memory
                                     for element in same_products}),
            'ram': check_no_data({element.phones_product_data.ram
                                  for element in same_products}),
            'battery': check_no_data({element.phones_product_data.battery
                                      for element in same_products}),
        ...
        same_products_data = {
            'items': same_products,
            'p_c_i_e': check_no_data({element.laptops_product_data.p_c_i_e
                                      for element in same_products}),
            'ram': check_no_data({element.laptops_product_data.ram
                                  for element in same_products}),
            'system': check_no_data({element.laptops_product_data.system
                                     for element in same_products}),
            'processor': check_no_data({element.laptops_product_data.processor
                                        for element in same_products}),
            'items_id': [element.id for element in same_products]
        }
        if product.laptops_product_data.producent == 'Apple':
            same_products_data['colors'] = {element.laptops_product_data.color
                                            for element in same_products}
        ...
        same_products_data = {
            'items': same_products,
            'p_c_i_e': check_no_data({element.pc_product_data.p_c_i_e
                                      for element in same_products}),
            'ram': check_no_data({element.pc_product_data.ram
                                  for element in same_products}),
            'system': check_no_data({element.pc_product_data.system
                                     for element in same_products}),
            'graph': check_no_data({element.pc_product_data.graph
                                    for element in same_products}),
            'processor': check_no_data({element.pc_product_data.processor
                                        for element in same_products}),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            'items': same_products,
            'colors': check_no_data({element.monitors_product_data.color
                                     for element in same_products}),
            ...
            'diagonal': check_no_data({
                element.monitors_product_data.diagonal
                for element in same_products}),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            ...
            'capacity': check_no_data({
                element.ssd_product_data.capacity
                for element in same_products}),
            'reading_speed': check_no_data({
                element.ssd_product_data.reading_speed
                for element in same_products}),
            'writing_speed': check_no_data({
                element.ssd_product_data.writing_speed
                for element in same_products}),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            'items': same_products,
            'capacity': check_no_data({
                element.ram_product_data.capacity
                for element in same_products}),
            'modules_number': check_no_data({
                element.ram_product_data.modules_number
                for element in same_products}),
            'delay': check_no_data({
                element.ram_product_data.delay
                for element in same_products}),
            'frequency': check_no_data({
                element.ram_product_data.frequency
                for element in same_products}),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            'items': same_products,
            'capacity': check_no_data({
                element.pendrive_product_data.capacity
                for element in same_products
                }),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            ...
            'num_of_poe': check_no_data({
                element.switch_product_data.num_of_poe
                for element in same_products}),
            'ports_num': check_no_data({
                element.switch_product_data.ports_num
                for element in same_products}),
            'bus_speed': check_no_data({
                element.switch_product_data.bus_speed
                for element in same_products}),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            'items': same_products,
            'diagonal': check_no_data({
                element.tv_product_data.diagonal
                for element in same_products
                }),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            ...
            'colors': check_no_data({
                element.headphone_product_data.color
                for element in same_products
                }),
            'items_id': [element.id for element in same_products]
        }
        ...
        same_products_data = {
            'items': same_products,
            'color': check_no_data({
                element.accesories_for_laptop.color
                for element in same_products
                }),
            'diagonal': check_no_data({
...
def find_new_product(product_items_list: List,
    ...
    help_dict = {
        ...
        'Phones': {
            'color': lambda id:
            models.MainProductDatabase.objects.get(
                id=int(id),
                color=product_data
                ),
            'memory': lambda id:
        ...
        models.MainProductDatabase.objects.get(
            id=int(id),
            product_data__capacity=product_data
            ),
        'Switches': {
        ...
        models.MainProductDatabase.objects.get(
            id=int(id),
            product_data__diagonal=product_data
            ),
        'Headphones': {
            'color': lambda id:
            models.MainProductDatabase.objects.get(
        ...
        try:
            if main_product.cattegory in help_dict:
                if product_parametr in help_dict[main_product.cattegory]:
                    product = help_dict[main_product.cattegory][
                        product_parametr](id)
                    return product
...
def get_product(model: str, instance: Any) -> models.MainProductDatabase:
    ...
    help_dict = {
        ...
        'accesoriesforlaptops': lambda instance:
            models.MainProductDatabase.objects.get(
...
def choose_model(model: str, instance) -> models.MainProductDatabase:
    ...
    help_dict = {
        'Phones': lambda instance:
            models.MainProductDatabase.objects.create(
                phones_product_data=instance
                ),
        'Monitors': lambda instance:
            models.MainProductDatabase.objects.create(
...
def try_to_get_product(product: "models.MainProductDatabase",
                       instance: Any) -> "models.MainProductDatabase":
    ...
    check_if_obj_is_instance_of = {
        ...
        'pc_product_data': lambda obj: isinstance(
            obj, models.Pc) if True else '',
        'monitors_product_data': lambda obj: isinstance(
            obj, models.Monitors) if True else '',
        'phones_product_data': lambda obj: isinstance(
            obj, models.Phones) if True else '',
        'laptops_product_data': lambda obj: isinstance(
            obj, models.Laptops) if True else '',
        'accesories_for_laptop': lambda obj: isinstance(
            obj, models.AccesoriesForLaptops) if True else '',
        'ssd_product_data': lambda obj: isinstance(
            obj, models.Ssd) if True else '',
        'graph_product_data': lambda obj: isinstance(
            obj, models.Graphs) if True else '',
        'ram_product_data': lambda obj: isinstance(
            obj, models.Ram) if True else '',
        'pendrive_product_data': lambda obj: isinstance(
            obj, models.Pendrives) if True else '',
        'switch_product_data': lambda obj: isinstance(
            obj, models.Switches) if True else '',
        'motherboard_product_data': lambda obj: isinstance(
            obj, models.Motherboard) if True else '',
        'cpu_product_data': lambda obj: isinstance(
            obj, models.Cpu) if True else '',
        'tv_product_data': lambda obj: isinstance(
            obj, models.Tv) if True else '',
        'headphone_product_data': lambda obj: isinstance(
            obj, models.Headphones) if True else '',
        'router_product_data': lambda obj: isinstance(
            obj, models.Routers) if True else '',
...
def sort_by_product_rate(products: QuerySet) -> List[QuerySet]:
    ...
    product_sorted = sorted(product_dict.items(),
