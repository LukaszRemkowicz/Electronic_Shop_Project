...
urlpatterns = [
    ...
    path('products/<str:cattegory>/',
         ProductsCart.as_view(), name="products_cart"),
    path('products/<str:cattegory>/<int:MainProductDatabase_id>/',
         ProductPage.as_view(), name="product_page"),
