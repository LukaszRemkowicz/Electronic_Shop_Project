...
urlpatterns = [
    ...
    path("profile-update/", views.ManageProfileView.as_view(), name="profile_update"),
    path(
        "order-cart-unauthorised-user/",
