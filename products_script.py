...
article.img.save('dqwd.png', File(open(r'electronic_shop/static/images/showcase/low res/dqwd.png', 'rb')))
...
article.img.save('koparka.jpg', File(open(r'electronic_shop/static/images/showcase/low res/koparka.jpg', 'rb')))
...
article.img.save('pc2.jpg', File(open(r'electronic_shop/static/images/showcase/low res/pc2.jpg', 'rb')))
